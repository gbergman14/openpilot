...
class LongitudinalMpc(object):
  ...
  def dynamic_follow_hopefully_tha_best(self, v_ego):
    ...
    if self.relative_velocity is not None:  # if lead
      ...
      y = [0.56, 0.5, 0.422, 0.336, 0.28, 0.21, 0.16, 0.112, 0.06502, 0, -0.0554, -0.1371, -0.2402, -0.3004]  # modification values  # modification percentages converted from normal TR mod array
